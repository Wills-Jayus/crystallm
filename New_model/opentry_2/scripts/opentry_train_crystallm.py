...
CRYSTALLM_ROOT = Path(os.environ.get(
    "CRYSTALLM_ROOT",
...
class TrainDefaults:
    ...
    reset_optimizer_on_resume: bool = False  # if True, load model weights but start a fresh optimizer
...
if __name__ == "__main__":
    ...
    if C.init_from == "resume":
        if C.reset_optimizer_on_resume:
            print("Resetting optimizer state after loading checkpoint weights.")
        else:
